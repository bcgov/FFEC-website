...
profileTab[nameShort == "Aseem", 
           nameDesc := paste("[Dr Aseem Sharma](https://sites.google.com/view/aseemrajsharma/home) - Research Climatologist", 
                             "",
                             paste(
                               "<!--TODO: add description-->"
                             ),
...
profileTab[nameShort == "Ceres", 
           nameDesc := paste("[Dr Ceres Barros](https:/www.researchgate.net/profile/Ceres-Barros) - Research Ecologist", 
                             ...
                             paste(
                               ...
                               "Alps, France, was a post-doctoral fellow and research associate at the",
                               "Ceres is currently on the [British Ecological Society Macroecology SIG](https://www.britishecologicalsociety.org/membership-community/special-interest-groups/macroecology/)",
                               "committee and on the [Response Diversity Network](https://responsediversitynetwork.github.io/RDN-website/who-we-are.html) committee,",
                               "and is an Associate Editor for [Ecological Solutions and Evidence](https://besjournals.onlinelibrary.wiley.com/journal/26888319)."
                             ),
                             sep = "<br>")]
